...
This module installs Flux on Kubernetes.
...
The module bundles an upstream release of Flux and makes it fully configurable with Kustomizations set as input attributes.
...
module "example_$module_name" {
  ...
  source  = "kubestack-modules/flux/kustomization"
